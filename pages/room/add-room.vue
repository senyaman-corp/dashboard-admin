    ...
    <div>
        <CardBaseCard title="Tambah Kamar">
            <FormBaseForm @submit="handleSubmit">
                <InputBaseInput v-model="formData.room_number" label="Nomor Kamar" placeholder="Masukkan Nomor Kamar" required />
                <InputBaseInput v-model="formData.name" label="Nama Kamar" placeholder="Masukkan Nama Kamar" />
                <InputWithCombobox v-model="formData.type" :options="roomTypes" label="Tipe Kamar" id="type" placeholder="Pilih Tipe Ruangan"/>
                <InputWithCombobox v-model="formData.view" :options="roomView" label="View Kamar" id="view" placeholder="Masukkan View Kamar"  />
