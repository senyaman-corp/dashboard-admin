<template>
  <CardBaseCard title="Data Reservasi">
            ...
            >
              <li class="dropdown-item">
                <a
                  ...
                  @click="deleteReservation(props.rowData.id)"
                >
              ...
              <li class="dropdown-item">
                <button
                  class="btn btn-default"
                  target="_blank"
                  @click="booking(props.rowData.id_booking_room)"
                >
...
const options = $dataTableOptions(
  config.public.baseUrl + "reservations/list",
  authStore.getToken
);
options.columnDefs = [
  {
